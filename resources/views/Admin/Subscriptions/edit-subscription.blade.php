...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
            <form action="{{ url('admin/subscriptions/'.$subscription->id) }}" method="POST">
                @csrf
                @method('PUT')
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Subscription Course <span class="text-danger">*</span></label>
                                @if(session('errors'))
                                <div class="text text-danger">{{session('errors')->first('name')}}*</div>
                                @endif
                                <input class="form-control" type="text" value="{{$subscription->course}}" name="name">
                            </div>
                        </div>
                        {{-- <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                @endif
                            <input class="form-control" type="email" value="{{$subscription->email}}" name="email">
                            </div>
                        </div> --}}
                        ...
                        {{-- <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="role" id="" class="form-control">
                                    <option value="{{$subscription->role}}">{{$subscription->role}}</option>
