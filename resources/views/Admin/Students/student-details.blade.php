    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-5 col-6 text-right m-b-30">
                <a href="{{ url('admin/students/'.$profile->id.'/edit ') }}" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="profile-view">
                        <div class="profile-img-wrap">
                            ...
                            <a href="#"><img class="avatar" src="{{$profile->profile_photo}}" alt=""></a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-7">
                                    <ul class="personal-info" style="font-size: 1rem">
                                        ...
                                        <li>
                                            ...
                                            <span class="text">{{$profile->home_address}}</span>
                                        </li>
                                        <li>
